backgrounds = {
    "Acolyte": {
        ...
        "reasons": [
            ...
            "My family gave me to a temple, since they were unwilling to care for me.",
            "I grew up in a householdwith strong religious convictions. Entering the service of one or more gods seemed natural.",
            "An impassioned sermon struck a chord deep within me, and moved me to serve the faith.",
    ...
    "Charlatan": {
        ...
        "gp": 15,
        "features": {"name": "False Identity", "description": "You have created a second identity that includes documentation, established acquaintances, and disguises that allow you to assume that persona. Additionally, you can forge documents including official papers and personal letters, as long as you have seen an example of the kind of document or the handwriting you are trying to copy.", "options": []},
        "personality traits": [
        ...
        "reasons": [
            ...
            "I learned early on that people are gullible and and easy to exploit",
            "I often got in trouble, but I managd to talk my way out of it every time.",
            "I took up with a confidence artist, from whom I learned my craft.",
            "Afteer a charlatan fleeced my family, I decided to learn the trade so I would never be fooled by such deception again",
    ...
    "Criminal/Spy": {
        ...
        "flaws": [],
        "reasons": [
            "I resented authority in my younger days and saw a life of crime as the best way to fight against tyrrany and oppression.",
            "Necesstity forced me to take up the life, since it was the only way I could survive.",
            "I fell in with a gang of reprobates and ne'er-do-wells, and I learned my specialty from them.",
            "A parent or relative taught me my criminal speciality to prepare me for the family business.",
            "I left home and found a place in a thieves' guild or some other criminal organization.",
            "I was always bored, so I turned to a crime to pass the time and discovered I as quite good at it.",
            ]
    },
    ...
    "Guild Artisan": {
        ...
        "flaws": [
            ...
            "No one must ever learn that 1 once stole money from guild coffers.",
